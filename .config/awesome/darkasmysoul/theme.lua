...
icondir = awful.util.getdir("config") .. "/darkasmysoul/icons"
-- }}}
...
-- {{{ Titlebars
theme.titlebar_bg_focus  = "#5a4343"
theme.titlebar_bg_normal = "#222222"
-- }}}

-- {{{ Tooltips
theme.tooltip_font = "tewi 8"
theme.tooltip_border_width = 1
theme.tooltip_border_color = "#5a4343"
theme.tooltip_opacity = 0.8
theme.tooltip_bg_color = "#222222"
theme.tooltip_fg_color = "#eeecec"
-- }}}

-- {{{ Taglist
--theme.taglist_bg_focus = "#161616"
--theme.taglist_fg_focus = "#8f5b5b"
--eme.taglist_fg_urgent = "#8f5b5b"
...
-- {{{ Icons
-- {{{ Taglist
theme.taglist_squares_sel   = icondir .. "/taglist/squarefza.png"
theme.taglist_squares_unsel = icondir .. "/taglist/squareza.png"
--theme.taglist_squares_resize = "false"
-- }}}

-- {{{ Misc
theme.awesome_icon           = icondir .. "/awesome16.png"
theme.menu_submenu_icon      = icondir .. "/menu/bullet.png"
theme.tasklist_floating_icon = icondir .. "/floatingw.png"
-- }}}
...
theme.menu_wbrowser = icondir .. "/menu/wbrowser.png"
theme.menu_fbrowser = icondir .. "/menu/fbrowser.png"
theme.menu_rwall = icondir .. "/menu/rwall.png"
